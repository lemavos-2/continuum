...
export function SessionNavBar() {
  ...
  return (
    ...
    >
      <motion.div
        className={cn(
          "relative z-40 flex text-muted-foreground h-full shrink-0 flex-col bg-white dark:bg-black transition-all",
        )}
                ...
                <ScrollArea className="h-16 grow p-2">
                  <div className={cn("flex w-full flex-col gap-1")}> 
                    ...
                    <Link
                      ...
                      className={cn(
                        "flex h-8 w-full flex-row items-center rounded-md px-2 py-1.5 transition hover:bg-muted hover:text-primary",
                        pathname?.includes("accounts") && "bg-muted text-blue-600",
                      )}
                    >
                    ...
                    <Link
                      ...
                      className={cn(
                        "flex h-8 w-full flex-row items-center rounded-md px-2 py-1.5 transition hover:bg-muted hover:text-primary",
                        pathname?.includes("competitors") && "bg-muted text-blue-600",
                      )}
                    >
